...
const MentorshipPage: React.FC = () => {
  ...
  const mentorshipOpportunities = (opportunities || []).filter(opp => opp.type === 'mentorship');
  
  const filteredOpportunities = mentorshipOpportunities.filter((opportunity) => {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div>
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Mentorship Opportunities</h2>
          <p className="text-gray-600">Connect with industry professionals and get personalized guidance</p>
        </div>
      </div>
      ...
      {filteredOpportunities.length > 0 ? (
        ...
        <div className="bg-white p-8 rounded-xl shadow-sm text-center">
          <h3 className="text-xl font-semibold text-gray-900 mb-2">No mentorship opportunities found</h3>
